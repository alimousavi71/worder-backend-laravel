            ...
            <div class="card">
                <div class="card-body pb-3">
                    ...
                    <form class="request-form forms-sample" method="post" action="{{ $routeUpdate }}">
                        ...
                        <x-admin.input identify="title" :title="trans('fields.acf-template.title')" type="text" :old="$acfTemplate->title"/>

                        <x-admin.select-model identify="template" key="key" value="value" :title="trans('fields.acf-template.template')" :items="$availableTemplates" :old="$acfTemplate->template" />

                        <x-admin.textarea identify="description" :title="trans('fields.acf-template.description')" :old="$acfTemplate->description"/>
