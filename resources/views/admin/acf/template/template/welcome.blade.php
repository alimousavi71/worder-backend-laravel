        ...
        <div class="row align-items-center">
            <div class="col-12 col-md-7 col-lg-6">
                <div class="welcome-intro">
                    ...
                    <div class="button-group store-buttons d-flex">
                        <a href="#">
                            <img src="{{ asset('res-front/assets/img/icon/google-play.png') }}" alt="">
                        </a>
                        <a href="#">
                            <img src="{{ asset('res-front/assets/img/icon/app-store.png') }}" alt="">
                        </a>
                    </div>
            ...
            <div class="col-12 col-md-5 col-lg-6">
                <div class="welcome-thumb mx-auto" data-aos="fade-left" data-aos-delay="500" data-aos-duration="1000">
                    <img src="{{ asset('res-front/assets/img/welcome/welcome-mockup.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>
